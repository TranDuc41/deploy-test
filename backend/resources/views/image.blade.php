...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mt-4">
            <div class="row">
                <div class="col-6">
                    <button class="btn btn-icon btn-3 btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addNewImage">
                        <span class="btn-inner--icon"><i class="ni ni-image"></i></span>
                        <span class="btn-inner--text">Thêm Ảnh</span>
                    </button>
                </div>
                <div class="col-6">
        ...
        <!-- Modal Add New-->
        <div class="modal fade" id="addNewImage" tabindex="-1" role="dialog" aria-labelledby="addNewUserTitle" aria-hidden="true">
