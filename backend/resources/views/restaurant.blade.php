...
<main class="main-content position-relative max-height-vh-100 h-100">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mt-4">
            <div class="row">
                <div class="col-6">
                    <button class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#exampleModalAddRoomType">Thêm Mới</button>
                </div>
                <div class="col-6">
            ...
            <div class="card">
                <div class="table-responsive">
                    <table class="table align-items-center mb-0" id="usersTable">
                        <thead>
                            <tr>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tên Nhà Hàng</th>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-xs">{{ $restaurant->name }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{ $restaurant->time_open }}</p>
                                </td>
                                <td class="align-middle text-center text-sm">
                                    <span class="text-secondary text-xs font-weight-bold">{{ $restaurant->time_close }}</span>
                                </td>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Thêm Nhà Hàng</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('restaurant') }}" method="POST" class="needs-validation" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Tên</label>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Nhập tên nhà hàng..." required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="drink_list" id="drink_list" class="form-control" required>
                                <div class="invalid-feedback">
                                    Please provide a valid.
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="file" name="food_menu" id="food_menu" class="form-control" required>
                                <div class="invalid-feedback">
                                    Please provide a valid.
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="file" name="restaurant_img" id="restaurant_img" class="form-control" required>
                                <div class="invalid-feedback">
                                    Please provide a valid.
                                </div>
                            </div>
