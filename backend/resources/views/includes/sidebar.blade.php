<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/">
            <img src="../assets/img/dominion-logo.png" class="navbar-brand-img h-100" alt="main_logo">
            <img src="../assets/img/dominion--.png" class="navbar-brand-img h-100" alt="main_logo">
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- Thong tin phong 
              ...
              --}}
            <li class="nav-item">
                <a class="nav-link {{ in_array(request()->path(), ['room-type', 'sale', 'amenities', 'rooms', 'edit-room', 'edit-room/*', 'packages']) ? 'active' : '' }}
            ...
            {{-- cho phép nhân viên --}}
            <li class="nav-item">
                <a class="nav-link {{ in_array(request()->path(), ['customer', 'invoices', 'payment', 'resevations']) ? 'active' : '' }}
                border-0 me-0 bg-gray-100"
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Quản Lý Nhà Hàng</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('restaurant') ? 'active' : '' }}" href="/restaurant">
                    ...
                    <span class="nav-link-text ms-1">Nhà Hàng</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('bookings') ? 'active' : '' }}" href="/bookings">
                    ...
                    <span class="nav-link-text ms-1">Lịch Đặt Bàn</span>
                </a>
            </li>
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Quản Lý SPA</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('spa') ? 'active' : '' }}" href="/spa">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">SPA</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('spa-bookings') ? 'active' : '' }}" href="/spa-bookings">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Lịch Đặt Spa</span>
                </a>
            </li>
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Quản Lý Faq</h6>
            </li>
            <li class="nav-item">
